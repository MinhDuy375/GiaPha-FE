...
export default function Kinship() {
    ...
    const lookup = async event => {
        event.preventDefault(); if (!fromId || !toId || fromId === toId) return;
